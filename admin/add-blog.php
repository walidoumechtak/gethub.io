        ...
        <div class="col-lg-10">
              ...
              <form action="" method="POST" enctype="multipart/form-data" class="row g-3">
                ...
                <div class="col-12">
                  ...
                  <div class="col-sm-10 ">
                      ...
                      <textarea name="desc" id="inputEmail" class="form-control" style="height: 500px;" >
                ...
                <div class="text-center">
                  <button type="submit" name="goo" class="btn btn-primary">Submit</button>
          ...
          <?php 
                      ...
                      if(isset($_POST['goo'])){
                            ...
                            if(empty($desc)){
                              $allErrors[] = "<p> Content is <strong> Required </strong> </p>";
                            }
                        ...
                        <?php  
                                                ...
                                                move_uploaded_file($image_tmp_name, "../themes/image/bloogImages/".$image);
                                                $imageIncludeToDataBases = 'themes/image/bloogImages/'. $image;

                                                  $timeCreation = date("Y-m-d");

                                             $sqlAddBooko = mysqli_query($con, "INSERT into `blogs` (`titre`,`contenu`,`dateCreation`,`bloogImage`) 
                                                values ('$title', \"$desc\", '$timeCreation' ,'$imageIncludeToDataBases')");
                                        ...
                                        if($sqlAddBooko){
                                            ...
                                            <div class="addbook-success alert alert-dismissible fade show" role="alert"">
                                                   Nice sure You have been added a blog successfully
                                            <button id="registreB" type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                             </div>
